...
// GetPods returns the Pods scheduled on this NodeInfo, as a slice of fwk.PodInfo interface.
...
// This is required by fwk.NodeInfo interface.
func (n *NodeInfo) AddPodInfo(pod fwk.PodInfo) {
	...
	pi := &PodInfo{Pod: pod.GetPod(), PodInfo: pod, PodExtraInfo: extraInfo}
	n.AddPod(pi)
}
